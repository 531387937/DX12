...
//     ThrowIfFailed(CreateDDSTextureFromFile12(md3dDevice.Get(),mCommandList.Get(),bricksTex->Filename.c_str(),
//         bricksTex->Resource,bricksTex->UploadHeap));
//
//     auto stoneTex = std::make_unique<Texture>();
//     stoneTex->Name = "stoneTex";
//     stoneTex->Filename = L"Textures/stone.dds";
//     ThrowIfFailed(CreateDDSTextureFromFile12(md3dDevice.Get(),mCommandList.Get(),stoneTex->Filename.c_str(),
//         stoneTex->Resource,stoneTex->UploadHeap));
//
//     auto tileTex = std::make_unique<Texture>();
//     tileTex->Name = "tileTex";
//     tileTex->Filename = L"Textures/tile.dds";
//     ThrowIfFailed(CreateDDSTextureFromFile12(md3dDevice.Get(),mCommandList.Get(),tileTex->Filename.c_str(),
...
// 	//slotRootParameter[0].InitAsShaderResourceView()
...
// {
// 	
//     mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\Texture.hlsl", nullptr, "VS", "vs_5_0");
//     mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\Texture.hlsl", nullptr, "PS", "ps_5_0");
// 	
//     mInputLayout =
//     {
