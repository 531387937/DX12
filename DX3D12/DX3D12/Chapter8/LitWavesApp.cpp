...
//
//             currMaterialCB->CopyData(mat->MatCBIndex, matCB);
//             mat->NumFramesDirty--;
//         }
//     }
// }
...
//     mMainPassCB.Lights[0].Strength = {1.0f, 0.0f, 0.9f};
//
...
//
//     CD3DX12_ROOT_SIGNATURE_DESC rootDesc(3, slotRootParameters, 0, nullptr,
//                                          D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT);
//
//     ComPtr<ID3DBlob> serializedSig = nullptr;
//     ComPtr<ID3DBlob> errorBlob = nullptr;
//
//     HRESULT hr = D3D12SerializeRootSignature(&rootDesc, D3D_ROOT_SIGNATURE_VERSION_1, serializedSig.GetAddressOf(),
