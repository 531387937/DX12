...
InstancingAndCullingApp::InstancingAndCullingApp(HINSTANCE hInstance): D3DApp(hInstance)
{
}
...
void InstancingAndCullingApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\Instance.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\Instance.hlsl", nullptr, "PS", "ps_5_1");
...
void InstancingAndCullingApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList,
